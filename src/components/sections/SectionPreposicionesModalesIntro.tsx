...
import { getPreposicionesModalesWarmupAsync } from "@/lib/workshop-loader";
import { useState, useEffect } from "react";

export function SectionPreposicionesModalesIntro() {
  ...
  useEffect(() => {
    const loadExercises = async () => {
      setLoading(true);
      try {
        const data = await getPreposicionesModalesWarmupAsync(
  ...
  const {
    ...
    recordHintUsed,
    resetSection,
  } = useSectionState("preposiciones-modales-warmup", exercises.length);
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>
          🎯 I. Repaso & Diagnóstico: Preposiciones Modales y Relacionales
        </CardTitle>
        <CardDescription>
          Identifica las preposiciones modales y relacionales correctas en
          ...
          <>
            ...
            <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
              <h3 className="font-semibold text-lg mb-3 text-blue-900 dark:text-blue-100">
                📚 Guía rápida: Preposiciones modales y relacionales
              </h3>
              <div className="space-y-3 text-sm">
                ...
                <div className="mt-4 p-3 bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-800 rounded">
                  ...
                  <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                    Estas preposiciones rigen un caso fijo que no cambia por
                    contexto espacial.
                  </p>
                </div>
              </div>
            ...
            {progress.completed && (
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Has refrescado las preposiciones modales y relacionales
                  básicas.
                </p>
              </div>
            )}
