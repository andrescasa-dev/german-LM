...
export function SectionPreposicionesIntro() {
  ...
  useEffect(() => {
    const loadExercises = async () => {
      setLoading(true);
      try {
        const data = await getPreposicionesTemporalesWarmupAsync("preposiciones-temporales", currentVariant);
        setExercises(data);
      } catch (error) {
        console.error("Failed to load exercises:", error);
        // Fallback to variant 1
        const data = await getPreposicionesTemporalesWarmupAsync("preposiciones-temporales", 1);
        setExercises(data);
      } finally {
        setLoading(false);
      }
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>🎯 I. Repaso & Diagnóstico: Preposiciones Temporales</CardTitle>
        <CardDescription>
          Identifica las preposiciones temporales correctas en diferentes contextos
        </CardDescription>
            ...
            <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <p>
                  ...
                  <br />
                  <span className="text-muted-foreground">
                    → "am Montag" (el lunes), "am Morgen" (por la mañana)
                  </span>
                </p>
                <p>
                  ...
                  <br />
                  <span className="text-muted-foreground">
                    → "im Mai" (en mayo), "im Sommer" (en verano)
                  </span>
                </p>
                <p>
